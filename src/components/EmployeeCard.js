    ...
    <div className={styles.page}>
      <main className={styles.card}>
        ...
        <div className={styles.contacts}>
          ...
          {/* WhatsApp */}
          {emp.whatsapp && (
            <a className={styles.row} href={waHref(emp.whatsapp, waText)} target="_blank" rel="noopener noreferrer">
              <span className={`${styles.ic} ${styles.icWa}`}>
                <svg viewBox="0 0 24 24">
                  <path d="M21 11.5a8.4 8.4 0 0 1-12.7 7.3L3 20l1.3-5.1A8.5 8.5 0 1 1 21 11.5Z" />
                  <path d="M8.5 8.8c.2-.5.4-.5.7-.5h.5c.2 0 .4 0 .6.5l.7 1.6c.1.2 0 .4-.1.5l-.4.5c-.1.1-.2.3-.1.5.3.6 1.3 1.6 2.1 2 .2.1.4.1.5 0l.5-.5c.2-.2.3-.2.6-.1l1.5.8c.2.1.3.2.3.4 0 .4-.2 1-.5 1.2-.3.2-1 .5-1.5.4-1.4-.2-3-1-4.2-2.4-1-1.1-1.6-2.4-1.6-3.3 0-.4.2-.9.4-1.1Z" fill="currentColor" stroke="none" />
                </svg>
              </span>
              <span className={styles.txt}>
          ...
          {/* Email -> mailto (Outlook if default) or Outlook web */}
          ...
          {/* Website */}
          <a className={styles.row} href={webHref(website)} target="_blank" rel="noopener noreferrer">
            <span className={styles.ic}>
              <svg viewBox="0 0 24 24">
        ...
        <div className={styles.footer}>
          ...
          {company.uaeBranches?.length > 0 && (
            <div className={styles.branches}>
              <b>UAE branches:</b> {company.uaeBranches.join(" · ")}
            </div>
          )}
        </div>
      </main>
